# _xl_models_data.py - SDXL Model Database for SD-DarkMaster-Pro Unified
# Original data source preserved from OlDocs - MANDATORY BASE for SDXL model selection
